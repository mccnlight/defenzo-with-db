...
export default function CoursesScreen() {
  ...
  const { courses, fetchCourses, fetchUserProgress, userProgress } = useCourseStore();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          // Calculate progress based on userProgress and course.lessons
          const courseProgress = userProgress?.filter(p => p.course_id === item.id && p.lesson_id) || [];
          ...
          // Override the course.progress with the calculated value
          const courseWithCalculatedProgress = { ...item, progress: calculatedProgress };

          return <CourseCard course={courseWithCalculatedProgress} />;
        }}
